...
namespace Dtg.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextFactory<DtgEFCoreDbContext>((serviceProvider, options) =>
            {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Version = "v1",
                    Description =
                        @"Use AddXafWebApi(options) in the Dtg.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                //    c.OAuthUsePkce();
                //});
                app.UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1/swagger.json", "DXApplication24 WebApi v1"); });
            }
            else
            {
